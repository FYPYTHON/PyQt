...
from kafkao.vendor import six

import kafkao.errors
from kafkao.errors import (UnknownError, ConnectionError, FailedPayloadsError,
                          KafkaTimeoutError, KafkaUnavailableError,
                          LeaderNotAvailableError, UnknownTopicOrPartitionError,
                          NotLeaderForPartitionError, ReplicaNotAvailableError)
from kafkao.structs import TopicPartition, BrokerMetadata

from kafkao.conn import (
    collect_hosts, BrokerConnection,
    ConnectionStates, get_ip_port_afi)
from kafkao.protocol import KafkaProtocol

# New KafkaClient
# this is not exposed in top-level imports yet,
# due to conflicts with legacy SimpleConsumer / SimpleProducer usage
from kafkao.client_async import KafkaClient
...
class SimpleClient(object):
    ...
    def _get_coordinator_for_group(self, group):
        ...
        # provided error
        kafkao.errors.check_error(resp)
    ...
    def load_metadata_for_topics(self, *topics, **kwargs):
        ...
        for error, topic, partitions in resp.topics:
            ...
            if error:
                error_type = kafkao.errors.kafka_errors.get(error, UnknownError)
